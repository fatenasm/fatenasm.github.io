...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/CV_04_02_26.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.researchgate.net/profile/Felipe-Atenas/", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://dblp.org/pid/339/9169.html", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/felipe-atenas-562838243", "_blank");
        },
      },{
      id: 'light-theme',
